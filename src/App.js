...
export default function App() {
  ...
  // useEffect(
  //   function () {
  //     console.log("Synchronized with the query state variable");
  //   },
  //   [query]
  // );
          ...
          <>
            {selectedId ? (
              ...
              <>
                ...
                <WatchedMoviesList
                  watched={watched}
                  onDeleteWacthed={handleDeleteWatched}
                />
              </>
            )}
          </>
...
function WatchedMoviesList({ watched, onDeleteWacthed }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie
...
function WatchedMovie({ movie, onDeleteWacthed }) {
  return (
    <li>
      <img src={movie.poster} alt={`${movie.title} poster`} />
      <h3>{movie.title}</h3>
